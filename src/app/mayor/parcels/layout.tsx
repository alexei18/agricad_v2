// src/app/mayor/parcels/layout.tsx
...
const PAGE_SPECIFIC_NAME = "Management Parcele";
...
export default function MayorParcelsLayout({ children }: Readonly<{ children: React.ReactNode }>) {

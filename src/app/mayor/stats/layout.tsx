// src/app/mayor/stats/layout.tsx
...
const PAGE_SPECIFIC_NAME = "Statistici Sat";
...
export default function MayorStatsLayout({ children }: Readonly<{ children: React.ReactNode }>) {

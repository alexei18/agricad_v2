// src/app/mayor/farmers/layout.tsx
...
const PAGE_SPECIFIC_NAME = "Gestionare Agricultori";
...
export default function MayorFarmersLayout({ children }: Readonly<{ children: React.ReactNode }>) {
